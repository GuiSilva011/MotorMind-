...
export async function criarCliente(req, res) {
  try {
    const { nome, cpf, email, dataNascimento,rg,cep, endereco,  bairro, cidade, uf, numero, celular, veiculos} = req.body;
      ...
      for (const veiculo of veiculos) {
        await prisma.veiculo.create({
          data: {
            ...
            anoModelo: veiculo.anoModelo ? Number(veiculo.anoModelo) : null
          }
        });
      }
    }
